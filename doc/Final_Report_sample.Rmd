...
Although the paper suggested the optimal $\lambda$ is 0.5, we found that 0.75 is better in this case.
...
for (i in 1:length(lambdas)){
  ...
  rmse.para[i, 2]<-sum(unlist(error))
}  
...
*mse()* function for calculating MSE.
```{r mse}
...
We can see that weight=0.7 minimized the RMSE in this case.
